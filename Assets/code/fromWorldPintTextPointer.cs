using UnityEngine;
    ...
    public class fromWorldPintTextPointer : IFloatingTextPosition
    {
        ...
        public fromWorldPintTextPointer(Camera camera,Vector3 worldPosition, float timeToLive, float speed)
        {
            _camera = camera;
